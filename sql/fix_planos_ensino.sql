-- Script para corrigir a estrutura da tabela planos_ensino

USE gecopec_db;

-- Fazer backup dos dados existentes se houver
CREATE TABLE IF NOT EXISTS planos_ensino_backup AS SELECT * FROM planos_ensino;
